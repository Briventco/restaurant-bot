...
const BASE_TRANSITIONS = {
  ...
  [ORDER_STATUSES.READY_FOR_PICKUP]: [ORDER_STATUSES.DELIVERED, ORDER_STATUSES.CANCELLED],
  [ORDER_STATUSES.RIDER_DISPATCHED]: [ORDER_STATUSES.DELIVERED, ORDER_STATUSES.CANCELLED],
